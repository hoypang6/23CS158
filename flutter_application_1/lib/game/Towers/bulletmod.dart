...
class BulletMod extends SpriteComponent with CollisionCallbacks, HasGameRef<GameSelf>{
  SpriteComponent? bulletTarget;
  Vector2? turretPos;
  
  BulletMod({required this.turretPos, required this.bulletTarget});

  @override
  void onLoad() async{
    await super.onLoad();
    sprite = await gameRef.loadSprite('modtracer.png');
