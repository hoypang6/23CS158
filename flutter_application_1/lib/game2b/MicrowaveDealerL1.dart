...
class MicrowaveDealerL1 extends SpriteComponent with CollisionCallbacks, HasGameRef<GameSelf>{
  MicrowaveDealerL1({required this.onThru, required this.enemyDowned});
  //bool spawned = false;
  int speed = 75; //default to 50
  int hp = 400; //Hit Points
 ...
 @override
  void onLoad() async{
    //spawned =true;
    await super.onLoad();
    sprite = await gameRef.loadSprite('microwave.png');
    size = Vector2(40, 40);
