...
import 'package:flutter_application_1/game2b/Hud%20elements/balanceshower.dart';
import 'package:flutter_application_1/game2b/Hud%20elements/gameover.dart';
import 'package:flutter_application_1/game2b/Hud%20elements/noBuildWarning.dart';
import 'package:flutter_application_1/game2b/Hud%20elements/winningscreen.dart';
import 'package:flutter_application_1/game2b/MicrowaveDealerL1.dart';
import 'package:flutter_application_1/game2b/ToasterDealerL1.dart';
import 'package:flutter_application_1/game2b/Hud%20elements/lifecount.dart';
import 'package:flutter_application_1/game2b/VacuumDealerL1.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../game2b/gameself.dart'; //change according to level


class Level2b extends World with HasGameRef<GameSelf>, HasCollisionDetection{
  ...
  void checkConditions(){
    ...
    if(letThru + enemyDowned == 70){ //Next level condition, should sum with numbers of kills (NK)
      currentWave++;
      wave4();
    }
    ...
    if(letThru + enemyDowned == 100){ //Win condition, NK
      gameRef.onWin();
      addWin();
      gameRef.endGame(); 
    }
  ...
  Future<void> wave2() async { //5 toasters 10 microwaves 5 vacuum (40)
  ...
  Future<void> wave3() async { //10 microwaves, 10 vacuums, 10 mw (70)
      await Future.delayed(Duration(seconds: 3));
    for(var i =0;i<10;i++){
      await Future.delayed(Duration(milliseconds: 800));
      addMicrowave();
  ...
  Future<void> wave4() async { //15 microwaves, 15 roombas (100)
    await Future.delayed(Duration(seconds: 3));
    for(var i =0;i<15;i++){
      await Future.delayed(Duration(milliseconds: 800));
      addMicrowave();
