...
class ToasterDealerL1 extends SpriteComponent with CollisionCallbacks, HasGameRef<GameSelf>{
  ToasterDealerL1({required this.onThru, required this.enemyDowned});
  //bool spawned = false;
  int speed = 50; //default to 50
  int hp = 150; //Hit Points
 ...
 @override
  void onLoad() async{
    //spawned =true;
    await super.onLoad();
    sprite = await gameRef.loadSprite('toaster.png');
    size = Vector2(40, 40);
